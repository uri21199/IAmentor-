...
export default function AgendaClient({ events, today }: Props) {
  ...
  if (dates.length === 0) {
    return (
      <div className="rounded-3xl bg-surface-2 border border-border-subtle p-10 text-center mt-2">
        ...
        <p className="text-sm font-semibold text-text-primary mb-1">Sin eventos próximos</p>
        <p className="text-xs text-text-secondary">
          Usá el botón + para agregar parciales, TPs o turnos médicos
        </p>
      </div>
    )
  }
